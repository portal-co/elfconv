...
*****************/
  ...
  if (print_result) {
    ...
    printf("Dhrystone(%s) time for %ld passes = %ld\n", Version, (long) numloops, benchtime);
    ...
    printf("Dhrystone(%s) time for %ld passes = %ld\n", Version, (long) numloops, benchtime / HZ);
    printf("This machine benchmarks at %ld dhrystones/second\n",
    ...
    {
      double t =
          (double) (endtime.ru_utime.tv_sec - starttime.ru_utime.tv_sec - nulltime.tv_sec) +
          (double) (endtime.ru_utime.tv_usec - starttime.ru_utime.tv_usec - nulltime.tv_usec) *
              1e-6;
      printf("Dhrystone(%s) time for %ld passes = %.1f\n", Version, (long) numloops, t);
